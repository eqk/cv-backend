...
\section{Summary}
  ...
  \resumeSubHeadingListStart
    \small{\item{
      Experienced Senior Scala Developer with over 5 years of hands-on experience in software development, specializing in back-end engineering. Proficient in Scala, and multiple frameworks and libraries, including Akka and Play. Skilled in CI/CD management, data engineering, and system integration, with a robust background in fintech fraud detection and telecommunication traffic processing. Certified Lightbend Reactive Architect with a passion for building scalable and efficient systems.
    }}
